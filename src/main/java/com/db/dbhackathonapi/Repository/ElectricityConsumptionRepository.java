...
public interface ElectricityConsumptionRepository extends CrudRepository<ElectricityConsumption, Integer> {
    ...
    void modifyUserInfoById(@Param("appliance_type") String appliance_type, @Param("duration_minutes") int duration_minutes, @Param("contributors") int contributors, @Param("ghg_footprint") String ghg_footprint, @Param("id") int id);
