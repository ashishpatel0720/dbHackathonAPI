...
public interface TravelActivityRepository extends CrudRepository<TravelActivity, Integer> {
    ...
    void modifyUserInfoById(@Param("medium") String medium, @Param("contributors") int contributors,@Param("distance") int distance, @Param("ghg_footprint") int ghg_footprint, @Param("id") int id);
